...
module vfb_profile_resolver (
	...
	localparam logic [1:0] KNEE_8   = 2'd2;
	...
	localparam logic COLORSPACE_G08_709 = 1'b1;
	...
	function automatic logic [29:0] fixed_240p;
		input logic [2:0] profile_i;
		begin
			case (profile_i)
				PROFILE_TOUCH: fixed_240p = pack_settings(
					DOT_2X, TONE_BRIGHT, BLOOM_THIN, CURVE_MILD_P,
					HALO_025X, CURVE_MILD, SPREAD_FOCUS, KNEE_16,
					INTER_OFF, INTRA_OFF,
				...
				PROFILE_OVERDRIVEN: fixed_240p = pack_settings(
					DOT_25X, TONE_LINEAR2, BLOOM_TIGHT, CURVE_MILD,
					HALO_025X, CURVE_MILD_P, SPREAD_FOCUS, KNEE_16,
					INTER_SHORT, INTRA_OFF,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
				PROFILE_NEON: fixed_240p = pack_settings(
					DOT_25X, TONE_LINEAR1, BLOOM_THIN, CURVE_MODERATE,
					HALO_033X, CURVE_MILD, SPREAD_FOCUS, KNEE_8,
					INTER_MEDIUM, INTRA_LUT_C,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
				PROFILE_STRANGER: fixed_240p = pack_settings(
					DOT_3X, TONE_BRIGHT, BLOOM_TIGHT, CURVE_MODERATE,
					HALO_033X, CURVE_MODERATE, SPREAD_FOCUS, KNEE_8,
		...
		begin
			case (profile_i)
				PROFILE_TOUCH: fixed_480p = pack_settings(
					DOT_2X, TONE_BRIGHT, BLOOM_TIGHT, CURVE_MILD,
					HALO_025X, CURVE_MILD, SPREAD_FOCUS, KNEE_32,
					INTER_OFF, INTRA_OFF,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
				PROFILE_TYPICAL: fixed_480p = pack_settings(
					DOT_2X, TONE_BRIGHT, BLOOM_TIGHT, CURVE_MILD_P,
					HALO_033X, CURVE_MILD, SPREAD_ORIGINAL, KNEE_8,
					INTER_SHORT, INTRA_OFF,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
				PROFILE_OVERDRIVEN: fixed_480p = pack_settings(
					DOT_25X, TONE_LINEAR2, BLOOM_TIGHT, CURVE_MOD_PLUS,
					HALO_033X, CURVE_MILD_P, SPREAD_ORIGINAL, KNEE_32,
					INTER_SHORT, INTRA_OFF,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
				PROFILE_NEON: fixed_480p = pack_settings(
					DOT_25X, TONE_LINEAR1, BLOOM_TIGHT, CURVE_STRONG_M,
					HALO_050X, CURVE_MILD_P, SPREAD_ORIGINAL, KNEE_24,
					INTER_MEDIUM, INTRA_LUT_C,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
				PROFILE_STRANGER: fixed_480p = pack_settings(
					DOT_3X, TONE_BRIGHT, BLOOM_NORMAL, CURVE_MILD_P,
					HALO_050X, CURVE_MOD_PLUS, SPREAD_ORIGINAL, KNEE_16,
					INTER_MEDIUM, INTRA_LUT_A,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
		...
		begin
			case (profile_i)
				PROFILE_TOUCH: fixed_720p = pack_settings(
					DOT_25X, TONE_BRIGHT, BLOOM_TIGHT, CURVE_MILD_P,
					HALO_025X, CURVE_MODERATE, SPREAD_FOCUS, KNEE_8,
					INTER_OFF, INTRA_OFF,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
				PROFILE_TYPICAL: fixed_720p = pack_settings(
					DOT_3X, TONE_BRIGHT, BLOOM_TIGHT, CURVE_MOD_PLUS,
					HALO_025X, CURVE_MOD_PLUS, SPREAD_FOCUS, KNEE_16,
					INTER_SHORT, INTRA_OFF,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
				PROFILE_OVERDRIVEN: fixed_720p = pack_settings(
					DOT_3X, TONE_BRIGHT, BLOOM_SOFT, CURVE_MILD_P,
					HALO_033X, CURVE_MODERATE, SPREAD_FOCUS, KNEE_24,
					INTER_MEDIUM, INTRA_OFF,
					COLORSPACE_G08_709, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
				PROFILE_NEON: fixed_720p = pack_settings(
					DOT_3X, TONE_OFF, BLOOM_NORMAL, CURVE_MOD_PLUS,
					HALO_050X, CURVE_MOD_PLUS, SPREAD_ORIGINAL, KNEE_16,
					INTER_LONG, INTRA_LUT_C,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
				PROFILE_STRANGER: fixed_720p = pack_settings(
					DOT_3X, TONE_BRIGHT, BLOOM_NORMAL, CURVE_MOD_PLUS,
					HALO_075X, CURVE_MOD_PLUS, SPREAD_WIDE2, KNEE_16,
					INTER_MEDIUM, INTRA_LUT_A,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
		...
		begin
			case (profile_i)
				PROFILE_TOUCH: fixed_1080p = pack_settings(
					DOT_3X, TONE_BRIGHT, BLOOM_TIGHT, CURVE_MODERATE,
					HALO_100X, CURVE_MINIMAL, SPREAD_FOCUS, KNEE_8,
					INTER_OFF, INTRA_OFF,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
				PROFILE_TYPICAL: fixed_1080p = pack_settings(
					DOT_3X, TONE_BRIGHT, BLOOM_SOFT, CURVE_MILD_P,
					HALO_050X, CURVE_MILD_P, SPREAD_WIDE2, KNEE_16,
					INTER_SHORT, INTRA_OFF,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_ON);
				PROFILE_OVERDRIVEN: fixed_1080p = pack_settings(
					DOT_3X, TONE_LINEAR2, BLOOM_NORMAL, CURVE_MILD_P,
					HALO_050X, CURVE_MILD_P, SPREAD_WIDE2, KNEE_16,
					INTER_MEDIUM, INTRA_OFF,
					COLORSPACE_G08_709, CHANNEL_ORIGINAL, SLOT_MASK_ON);
				PROFILE_NEON: fixed_1080p = pack_settings(
					DOT_3X, TONE_OFF, BLOOM_BROAD, CURVE_STRONG_M,
					HALO_100X, CURVE_MILD_P, SPREAD_WIDE2, KNEE_16,
					INTER_LONG, INTRA_LUT_C,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_ON);
				PROFILE_STRANGER: fixed_1080p = pack_settings(
					DOT_3X, TONE_BRIGHT, BLOOM_BROAD, CURVE_MODERATE,
					HALO_100X, CURVE_MODERATE, SPREAD_WIDE1, KNEE_8,
					INTER_LONG, INTRA_LUT_A,
					COLORSPACE_OFF, CHANNEL_ORIGINAL, SLOT_MASK_OFF);
