...
//
//  Builds the LS253 matrix bytes and FC port from MiSTer joystick inputs.
//  Bit positions follow MAME segag80v.cpp.
//
//  Input polarity conventions:
//    * D7D6 / D5D4 bits are ACTIVE LOW (switch to ground), so idle is 1.
//    * The FC port is ACTIVE HIGH except for Space Fury bits 5-7.
//
...
module sega_inputs (
	...
	always_comb begin
		...
		// FC (active high): 4 = P2 B2, 5 = P2 B1,
		//                   6 = P2 RIGHT, 7 = P2 LEFT
		sega_game_pkg::GAME_ELIM2C: begin
			in_d5d4[1] = ~start1;
			in_d5d4[2] = ~p1_l;
			in_d5d4[3] = ~p1_b1;
			in_d5d4[5] = ~start2;
			in_d5d4[6] = ~p1_r;
			in_d5d4[7] = ~p1_b2;
			in_fc      = {p2_l, p2_r, p2_b1, p2_b2, 4'b0000};
		end
		...
		// D5D4: 1 = START1, 2 = P1 LEFT, 3 = P1 B1,
		//       5 = START2, 6 = P1 RIGHT, 7 = P1 B2
		// FC: bit 4 active high, bits 5-7 active low
